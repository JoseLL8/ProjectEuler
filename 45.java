//obviously every hexagonal number is also triangular, so we only need to calculate hexagonal and pentagonal numbers
import java.util.*;

class Problem45 {
	public static void main(String[] args) {
		long h = 1; //if the counters arent also long, they overflow and lock the program into the while (pn<hn) due to negative numbers
		long hn = 1;
		long p = 1;
		long pn = 1;
		while (true) {
